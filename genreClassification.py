...
model_path = r"./model/genre_classification_84.h5"
...
# model_path = r"C:\Users\ACER\OneDrive\文档\Capstone Analisis Sentimen\Capstone Analisis Sentimen\genre_classification_84.h5"
# image_model = load_model(model_path)
...
#                 return jsonify({'probability': image_predictions})
#             finally:
#                 os.remove(file_path)
#         else:
#             return jsonify({'error': 'No image uploaded for genre prediction'}), 400
